...
namespace MoreLinq.Experimental.Async
{
    ...
    static partial class MoreAsyncEnumerable
    {
        ...
        /// <returns>An asynchronous sequence of equally sized buckets containing elements of the source collection.</returns>
        public static IAsyncEnumerable<IEnumerable<TSource>> Batch<TSource, TResult>(this IAsyncEnumerable<TSource> source, int size, Func<IEnumerable<TSource>, TResult> resultSelector)
        {
        ...
        private static async IAsyncEnumerable<IEnumerable<TSource>> BatchInternal<TSource, TResult>(
            this IAsyncEnumerable<TSource> source, int size, Func<IEnumerable<TSource>, TResult> resultSelector)
        {
            // TODO: implement
